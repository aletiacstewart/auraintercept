...
const INDUSTRIES: IndustryDef[] = [
  ...
  // HEALTHCARE (6) — appointments + insurance verification email only.
  // No EHR/PMS, prescriptions, clinical advice, or medical records.
  industry('dental', 'Dental Practice', 'boost',
    ['Cleaning','Exam','Filling','Whitening','Recall Visit'],
    null,
    [
      { title: 'Why Recall Visits Matter', excerpt: 'Twice-a-year cleanings catch problems early.', content: '## Recall basics\n\nWe send appointment reminders and recall texts — no medical records or treatment advice.' },
      { title: 'Insurance Verification, Simplified', excerpt: 'We email your front desk to verify benefits before the visit.', content: '## How it works\n\nPatient submits insurance info on booking; an email goes to your front desk for manual verification.' },
      { title: 'Cutting No-Shows With Smart Reminders', excerpt: 'Two reminders, one confirmation.', content: '## Cadence\n\n48-hour SMS, 2-hour SMS, optional voice call for repeat no-shows.' },
    ],
    [
      { name: 'New Patient Welcome', promo_code: 'NEWSMILE', discount_value: 0, message: 'New patients: free intake call + appointment booking.', subject: 'Welcome — Book Your First Visit' },
      { name: 'Recall Reactivation', promo_code: 'RECALL', discount_value: 0, message: 'It\'s been a while — book your cleaning today.', subject: 'Time for Your Cleaning' },
    ],
  ),
  industry('chiropractic', 'Chiropractic', 'core',
    ['Initial Consult','Adjustment','Re-Evaluation','Recall Visit','Wellness Check'],
    null,
    [
      { title: 'Booking Recurring Adjustments', excerpt: 'Set a cadence and we handle reminders.', content: '## Cadence\n\nWeekly, biweekly, or monthly — automated reminders, no clinical notes.' },
      { title: 'Recall Reminders That Work', excerpt: 'Patients lapse. SMS recall brings them back.', content: '## Playbook\n\n30/60/90-day SMS sequences for inactive patients.' },
      { title: 'What Aura Will and Will Not Do', excerpt: 'Front-office only — never clinical.', content: '## Scope\n\nBookings, reminders, intake forms. Not records, diagnoses, or treatment advice.' },
    ],
    [
      { name: 'New Patient Consult', promo_code: 'CHIRO0', discount_value: 0, message: 'Free initial consult — book online today.', subject: 'Free Consult — Find Out If We Can Help' },
      { name: 'Wellness Plan Reminder', promo_code: 'WELLNESS', discount_value: 0, message: 'Stay on track — book your monthly adjustment.', subject: 'Time for Your Adjustment' },
    ],
  ),
  industry('medical_office', 'Medical Office', 'pro',
    ['New Patient Visit','Follow-Up','Annual Physical','Telehealth Consult','Insurance Verification'],
    null,
    [
      { title: 'Front-Desk Insurance Email Workflow', excerpt: 'We email your team — they verify.', content: '## Process\n\nPatient submits insurance on booking. Aura emails the front desk; staff verify with the carrier.' },
      { title: 'Reducing Phone Tag', excerpt: 'SMS confirmations cut callback volume by 40%.', content: '## Why\n\nMost patients prefer SMS. Confirm, reschedule, and remind without picking up the phone.' },
      { title: 'HIPAA-Aware Front Office', excerpt: 'No PHI in SMS — appointment metadata only.', content: '## Boundaries\n\nWe send time/date/location; never diagnoses, results, or medications.' },
    ],
    [
      { name: 'Annual Physical Reminder', promo_code: 'PHYSICAL', discount_value: 0, message: 'Time for your annual physical — book today.', subject: 'Annual Physical — Book Now' },
      { name: 'New Patient Welcome', promo_code: 'NEWPATIENT', discount_value: 0, message: 'Welcome! Book your first visit and we\'ll handle insurance verification.', subject: 'Welcome to the Practice' },
    ],
  ),
  industry('veterinary', 'Veterinary Clinic', 'boost',
    ['Wellness Exam','Vaccination','Dental Cleaning','Recall Visit','Nail Trim'],
    null,
    [
      { title: 'Pet-Aware Booking', excerpt: 'Pet name + species captured at intake.', content: '## How it works\n\nPet info is stored as JSON on the appointment — no medical records, no Rx.' },
      { title: 'Vaccine Recall Reminders', excerpt: 'Annual reminders go out automatically.', content: '## Setup\n\nPick a recall window; SMS + email sent at 30 and 7 days before due date.' },
      { title: 'What We Don\'t Do', excerpt: 'No vet records, no prescriptions, no lab results.', content: '## Scope\n\nFront-office only: bookings, reminders, intake. All clinical work stays in your PIMS.' },
    ],
    [
      { name: 'Wellness Exam Reminder', promo_code: 'WELLNESS', discount_value: 0, message: 'Time for your pet\'s wellness exam — book today.', subject: 'Time for a Wellness Exam' },
      { name: 'New Pet Welcome', promo_code: 'NEWPET', discount_value: 0, message: 'New furry family member? Book their first visit.', subject: 'Welcome Your New Pet' },
    ],
  ),
  industry('physical_therapy', 'Physical Therapy', 'core',
    ['Initial Eval','Therapy Session','Re-Evaluation','Recall Visit','Discharge Visit'],
    null,
    [
      { title: 'Recurring Sessions Made Simple', excerpt: 'Book a 6-week plan in one click.', content: '## Plan booking\n\nPatients confirm a recurring slot; reminders handled automatically.' },
      { title: 'Drop-Off Recovery', excerpt: 'Bring lapsed patients back with one SMS.', content: '## Sequences\n\n7/14/30-day SMS reactivation cadence.' },
      { title: 'No Clinical Data', excerpt: 'Front-office only by design.', content: '## Scope\n\nBookings, reminders, intake forms. Treatment plans and SOAP notes stay in your EMR.' },
    ],
    [
      { name: 'Free Screening', promo_code: 'PT0', discount_value: 0, message: 'Free 15-min screening — book online today.', subject: 'Free PT Screening' },
      { name: 'Plan Reactivation', promo_code: 'COMEBACK', discount_value: 0, message: 'Pick up where you left off — book your next session.', subject: 'Time to Get Back on Track' },
    ],
  ),
  industry('optometry', 'Optometry', 'core',
    ['Eye Exam','Contact Fitting','Frame Selection','Recall Visit','Insurance Verification'],
    null,
    [
      { title: 'Annual Exam Recall', excerpt: 'Most patients forget. We don\'t.', content: '## Cadence\n\n11-month and 12-month SMS + email recall reminders.' },
      { title: 'Vision Insurance, Verified', excerpt: 'Front desk gets the email; carrier gets the call.', content: '## Workflow\n\nPatient submits VSP/EyeMed info; Aura emails staff for verification.' },
      { title: 'Booking Without the Hold Music', excerpt: 'SMS + online booking, 24/7.', content: '## Result\n\nPatients book in 60 seconds; your phones stay free for clinical questions.' },
    ],
    [
      { name: 'Annual Exam Reminder', promo_code: 'EXAM', discount_value: 0, message: 'Time for your annual eye exam — book today.', subject: 'Annual Eye Exam — Book Now' },
      { name: 'Contacts Refill Reminder', promo_code: 'CONTACTS', discount_value: 0, message: 'Running low? Book a contact lens follow-up.', subject: 'Time to Refill Your Contacts' },
    ],
  ),
];
