...
const INDUSTRY_DEFAULTS: Record<string, IndustryDef> = {
  ...
  solar: { label: 'Solar Energy', services: ['Site Assessment','Solar Install','Battery Backup','Panel Cleaning','System Maintenance'], categories: ['Solar'], primary: '#F59E0B', secondary: '#FCD34D', ...PHOENIX, sampleAppointment: { service: 'Site Assessment', whenOffsetHours: 72, notes: '$380/mo bill, south-facing roof, 8 yrs old. Homeowner financing.' }, sampleLead: { source: 'widget', intent: 'quote', serviceInterest: 'Solar Install', priority: 'high', score: 80 } },
  ...
  restaurants: { label: 'Restaurants', services: ['Booking Link','Menu Link','Catering Inquiry','Private Event','Hours & Location'], categories: ['Restaurants'], primary: '#B91C1C', secondary: '#F87171', ...ORLANDO, sampleLead: { source: 'chat', intent: 'inquiry', serviceInterest: 'Catering', priority: 'high', score: 75 } },
