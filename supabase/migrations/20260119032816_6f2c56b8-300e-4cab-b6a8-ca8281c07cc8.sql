-- Drop and recreate the RPC function with correct signature
...
GRANT EXECUTE ON FUNCTION public.get_website_public_data(text) TO anon, authenticated, service_role;