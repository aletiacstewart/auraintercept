...
export const MAIN_INDUSTRY_CATEGORIES: MainIndustryCategory[] = [
  ...
  { name: 'Cleaning & Restoration',      icon: Sparkles,       count: 13, description: 'House, carpet, water/fire damage',       demoPack: 'handyman',           subTypeCategory: 'Cleaning & Restoration' },
  ...
  { name: 'Home Inspection & Safety',    icon: Shield,         count: 11, description: 'Inspectors, chimney, locksmith, alarms', demoPack: 'security_systems',   subTypeCategory: 'Home Inspection & Safety' },
  ...
  { name: 'Moving & Junk Removal',       icon: Truck,          count: 9,  description: 'Movers, junk, towing, waste',            demoPack: 'handyman',           subTypeCategory: 'Moving & Junk Removal' },
  ...
  { name: 'Pet & Animal Services',       icon: PawPrint,       count: 8,  description: 'Groomers, trainers, vets, sitters',      demoPack: 'veterinary',         subTypeCategory: 'Pet & Animal Services' },
  { name: 'Health & Wellness',           icon: HeartPulse,     count: 1,  description: 'In-home massage & therapists',           demoPack: 'beauty_wellness',    subTypeCategory: 'Health & Wellness (In-Home)' },
  { name: 'Specialty Trades',            icon: Hammer,         count: 13, description: 'Handyman, carpenter, pool, masonry',     demoPack: 'handyman',           subTypeCategory: 'Specialty Trades' },
  { name: 'Utility & Infrastructure',    icon: Building2,      count: 3,  description: 'Propane, water, utility contractors',    demoPack: 'plumbing',           subTypeCategory: 'Utility & Infrastructure' },
  ...
  { name: 'In-Home Personal Services',   icon: Users,          count: 11, description: 'Trainer, tutor, nanny, chef, PA',        demoPack: 'personal_assistant', subTypeCategory: 'In-Home Personal Services' },
  { name: 'Delivery & On-Site Logistics',icon: Send,           count: 4,  description: 'Furniture, fuel, water delivery',        demoPack: 'handyman',           subTypeCategory: 'Delivery & On-Site Logistics' },
  { name: 'Insurance & Assessment',      icon: FileText,       count: 4,  description: 'Home/auto, adjusters, appraisers',       demoPack: 'real_estate',        subTypeCategory: 'Insurance & Assessment' },
  { name: 'Senior & Lifestyle',          icon: HeartHandshake, count: 5,  description: 'Senior move, organize, energy audit',    demoPack: 'home_health',        subTypeCategory: 'Senior & Lifestyle Services' },
  { name: 'Event & Temporary',           icon: Megaphone,      count: 6,  description: 'Tents, party, DJ, catering, photo',      demoPack: 'beauty_wellness',    subTypeCategory: 'Event & Temporary Services' },
  ...
  { name: 'B2B Pro Services',            icon: Briefcase,      count: 0,  description: 'Consultants & professional services',    demoPack: 'real_estate' },
];
