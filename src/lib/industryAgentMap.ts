...
const INDUSTRY_OVERRIDES: Record<string, PartialConfig> = {
  ...
  electrical: { consoleTitle: 'Electrical Service Delivery Console', workerConsoleTitle: 'Electrician Console' },
  appliance_repair: { consoleTitle: 'Appliance Repair Console', workerConsoleTitle: 'Repair Technician Console' },
  landscape: { consoleTitle: 'Crew Route Console', workerConsoleTitle: 'Crew Console', teamMemberNoun: 'Crew Member', jobNoun: 'Visit', assignmentAgentName: 'Crew Assignment Agent' },
  pest_control: { consoleTitle: 'Treatment Route Console', workerConsoleTitle: 'Pest Tech Console', teamMemberNoun: 'Pest Tech', jobNoun: 'Treatment Visit', assignmentAgentName: 'Route Assignment Agent' },
  pool_spa: { consoleTitle: 'Pool Route Console', workerConsoleTitle: 'Pool Tech Console', teamMemberNoun: 'Pool Tech', jobNoun: 'Service Visit', assignmentAgentName: 'Route Assignment Agent' },
  roofing: { consoleTitle: 'Roofing Operations Console', workerConsoleTitle: 'Roofing Crew Console', teamMemberNoun: 'Crew Member', jobNoun: 'Inspection / Job', specialistShow: ['insurance_claim', 'site_survey'] },
  solar: { consoleTitle: 'Solar Project Console', workerConsoleTitle: 'Solar Crew Console', teamMemberNoun: 'Crew Member', jobNoun: 'Install', specialistShow: ['site_survey', 'permit_code'] },
  fencing: { consoleTitle: 'Install Crew Console', workerConsoleTitle: 'Crew Console', teamMemberNoun: 'Crew Member', jobNoun: 'Install' },
  construction: { consoleTitle: 'Project Operations Console', workerConsoleTitle: 'Project Crew Console', teamMemberNoun: 'Crew Member', jobNoun: 'Project', specialistShow: ['site_survey', 'permit_code'] },
  handyman: { consoleTitle: 'Handyman Service Console', workerConsoleTitle: 'Service Pro Console', teamMemberNoun: 'Service Pro', jobNoun: 'Task' },
  security_systems: { consoleTitle: 'Security Install Console', workerConsoleTitle: 'Security Tech Console', teamMemberNoun: 'Security Tech', jobNoun: 'Install' },
  mobile_mechanic: { consoleTitle: 'Mobile Mechanic Console', workerConsoleTitle: 'Mechanic Console', teamMemberNoun: 'Mechanic', jobNoun: 'Service Call' },
  auto_care: {
  ...
  salon: salonLike,
  fitness: { consoleTitle: 'Class & Session Console', workerConsoleTitle: 'Trainer Console', workerLayoutTitle: 'Trainer Workspace', teamMemberNoun: 'Trainer', providerNoun: 'Trainer', customerNoun: 'Member', jobNoun: 'Session', roomNoun: 'Studio' },
  restaurants: {
