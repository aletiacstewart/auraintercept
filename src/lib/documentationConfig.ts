...
export const SUBSCRIPTION_TIERS: Record<string, TierConfig> = {
  ...
  single_point: {
    ...
    highlights: [
      ...
      '1 Console: Customer Portal',
      'Talk to Aura + Proxy Voice Chat included',
...
export const CONSOLES: ConsoleConfig[] = [
  {
    ...
    description: 'AI-powered customer engagement hub with Talk to Aura, Proxy Voice Chat, automated follow-ups, and review collection.',
    tier: 'halo',
    agentCount: 4,
