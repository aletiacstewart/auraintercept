...
export const SUBSCRIPTION_TIERS: Record<string, TierConfig> = {
  ...
  core: {
    ...
    operatives: 3,
    consoles: 3,
    description: 'AI-assisted digital foundation with up to 3 operatives.',
    bestFor: 'Businesses wanting AI-ready tools with basic automation.',
    highlights: [
  ...
  multi_track: {
    ...
    operatives: 12,
    consoles: 7,
    description: 'Full field operations with up to 12 AI operatives.',
