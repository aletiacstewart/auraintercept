...
export const SUBSCRIPTION_TIERS: Record<string, TierConfig> = {
  ...
  aura_pro: {
    ...
    annualPrice: 19085,
    annualSavings: 4771,
    implementationFee: 994,
    originalImplementationFee: 1988,
    employees: 50,
    operatives: 16,
    consoles: 5,
  ...
  aura_elite: {
    ...
    annualPrice: 38198,
    annualSavings: 9550,
    implementationFee: 1990,
    originalImplementationFee: 3979,
    employees: 'Unlimited',
    operatives: 24,
    consoles: 7,
