...
const OVERRIDES: Record<string, WorkflowChain[]> = {
  ...
  restaurants: [
    { id: 'reservations-prep', label: 'Reservations Prep',
      description: 'Brief on tonight’s service and special requests',
      icon: Utensils, steps: ['Pull Bookings', 'VIPs', 'Brief'],
      command: 'Brief me on tonight’s reservations: covers, VIPs, allergies, special occasions, and prep notes' },
    { id: 'no-show-recovery', label: 'No-Show / Cancel Recovery',
      description: 'Backfill canceled tables and follow up',
      icon: Phone, steps: ['Detect', 'Backfill', 'Notify'],
      command: 'For tonight’s cancels and no-shows, scan the waitlist, propose backfills, and notify guests' },
