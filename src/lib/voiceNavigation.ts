...
export const PAGE_ROUTES: Record<string, string> = {
  ...
  '3rd party overview': '/dashboard/integrations',
  'voice agent': '/dashboard/integrations?open=elevenlabs',
  'voice integration': '/dashboard/integrations?open=elevenlabs',
  'sms & text': '/dashboard/integrations?open=signalwire',
  'sms and text': '/dashboard/integrations?open=signalwire',
  'sms': '/dashboard/integrations?open=signalwire',
  'sms settings': '/dashboard/integrations?open=signalwire',
  'text': '/dashboard/integrations?open=signalwire',
  'text settings': '/dashboard/integrations?open=signalwire',
  'email': '/dashboard/integrations?open=resend',
  'email integration': '/dashboard/integrations?open=resend',
  'email settings': '/dashboard/integrations?open=resend',
  'calendar integration': '/dashboard/integrations?open=google_calendar',
