...
const CLUSTER: Record<IndustryPack['cluster'], PortalCopy> = {
  trades: {
    ...
    description: 'AI customer service portal for service trades',
  ...
  outdoor: {
    ...
    description: 'AI portal for property owners on recurring service routes',
  ...
  repair: {
    title: 'Customer Portal Console',
    description: 'AI ticket portal for repair customers',
  ...
  booking: {
    ...
    description: 'AI booking portal for clients',
  ...
  home_health: {
    ...
    description: 'AI portal for patients and family caregivers',
...
const OVERRIDES: Record<string, Partial<PortalCopy>> = {
  real_estate: { title: 'Buyer & Seller Portal',
    description: 'AI portal for buyers, sellers, and showings',
  ...
  beauty_wellness: { title: 'Client Portal',
    description: 'AI booking portal for salon and spa clients',
  ...
  restaurants: { title: 'Guest Portal',
    description: 'AI reservation portal for guests',
  ...
  personal_assistant: { title: 'Client Portal',
    description: 'AI concierge portal for clients',
  ...
  veterinary: { title: 'Pet Owner Portal',
    description: 'AI portal for pet owners to book and manage visits',
  ...
  medical_practice: { title: 'Patient Portal',
    description: 'AI portal for patients to book and manage visits',
    specialistSubtitle: 'Patient-facing specialists for scheduling, insurance, and care questions.',
    customerNoun: 'Patient', requestNoun: 'Visit Request',
    portalHeaderLabel: 'Patient Portal',
