...
export const DEMO_FEATURE_STATUS: DemoFeatureRow[] = [
  ...
  },
  {
    ...
    requires: 'SignalWire phone number + ElevenLabs voice agent (bundled in your plan).',
  },
  {
    id: 'sms_outbound',
    ...
    requires: 'SignalWire 10DLC-registered number (bundled in your plan; one-time A2P registration included).',
  },
  {
    id: 'email',
    ...
    requires: 'Verified sending domain (email delivery bundled in your plan).',
  },
  {
    id: 'gcal',
