...
const OVERRIDES: Record<string, Partial<MarketingPlaybook>> = {
  ...
  dental: { tagline: 'Reactivate hygiene, fill the chair',
    campaigns: [
      { title: 'Recall Reactivation', description: 'Reach patients overdue for a cleaning',
        command: 'Find patients overdue for a hygiene visit and draft a HIPAA-safe reactivation campaign — no clinical details' },
      { title: 'New-Patient Welcome', description: 'Onboarding for new families',
        command: 'Build a new-patient welcome series covering forms, insurance, and what to expect, and queue for approval' },
      { title: 'Cosmetic Consult Drive', description: 'Promote whitening / clear aligners',
        command: 'Build a cosmetic consult drive for whitening and aligners targeting active patients, and queue for approval' },
    ] },
  medical_office: { tagline: 'Fewer no-shows, more annuals booked',
    campaigns: [
      { title: 'Annual Physical Reminder', description: 'Reach patients due for annuals',
        command: 'Find patients due for an annual physical and draft a HIPAA-safe reminder campaign — no clinical details' },
      { title: 'Flu / Vaccine Drive', description: 'Seasonal vaccine push',
        command: 'Build a seasonal vaccine availability campaign for active patients and queue for approval' },
      { title: 'Telehealth Awareness', description: 'Promote virtual visit option',
        command: 'Build a telehealth awareness campaign explaining virtual visit availability and queue for approval' },
    ] },
  chiropractic: { tagline: 'Plan adherence and re-evaluations',
    campaigns: [
      { title: 'Care Plan Re-Eval', description: 'Reach patients due for re-evaluation',
        command: 'Find patients due for a care plan re-evaluation and draft a HIPAA-safe outreach campaign' },
      { title: 'Posture Workshop', description: 'Educational workshop funnel',
        command: 'Plan a posture-and-ergonomics workshop funnel with sign-up campaign and queue for approval' },
      { title: 'Refer-a-Friend', description: 'Patient referral incentive',
        command: 'Build a patient refer-a-friend campaign with a clear thank-you reward, and queue for approval' },
    ] },
  physical_therapy: { tagline: 'Adherence to plan of care',
    campaigns: [
      { title: 'Plan Adherence Drip', description: 'Keep patients on plan',
        command: 'Build an adherence drip campaign with weekly encouragement and home-exercise reminders — no clinical details' },
      { title: 'Discharged Patient Check-In', description: 'Re-engage former patients',
        command: 'Find patients discharged 60-90 days ago and draft a check-in / wellness campaign' },
      { title: 'Sports Season Prep', description: 'Pre-season conditioning push',
        command: 'Build a sports-season conditioning campaign aimed at active local leagues and queue for approval' },
    ] },
  optometry: { tagline: 'Annual exams and eyewear refresh',
    campaigns: [
      { title: 'Annual Exam Recall', description: 'Patients due for yearly exam',
        command: 'Find patients due for an annual eye exam and draft a HIPAA-safe recall campaign — no clinical details' },
      { title: 'Frame Style Refresh', description: 'Promote new frame collection',
        command: 'Build a new frame collection campaign for patients eligible for benefits this year' },
      { title: 'Contact Lens Refill', description: 'Reorder reminder',
        command: 'Find patients due for a contact lens reorder and draft a refill reminder campaign' },
    ] },
  veterinary: { tagline: 'Wellness visits and vaccine compliance',
    campaigns: [
      { title: 'Vaccine Due Reminder', description: 'Pets due for vaccines',
        command: 'Find pets due for vaccines in the next 30 days and draft a reminder campaign to the owner' },
      { title: 'Wellness Plan Push', description: 'Convert visits into wellness plans',
        command: 'Identify owners not on a wellness plan and draft an enrollment campaign with plan benefits' },
      { title: 'Senior Pet Outreach', description: 'Senior screening packages',
        command: 'Find senior pets and draft a senior-screening package campaign to the owner' },
    ] },
};
