...
export const CONSOLE_HELP_CONFIG: ConsoleHelpConfig[] = [
  ...
  {
    id: 'social_media',
    title: 'Social Signal Ops',
    icon: Share2,
    description: 'AI-powered social signal management with content creation for 6 platforms, scheduling, and visual content calendar.',
    requiredTier: 'command',
    tabs: ['New Post', 'Drafts', 'Scheduled', 'Calendar'],
    agents: [
      { name: 'Social Signal Agent', tier: 'command' },
...
export const TIER_HELP_DESCRIPTIONS: Record<SubscriptionTier, { title: string; description: string; highlights: string[] }> = {
  ...
  core: {
    title: 'Aura Core',
    description: 'Entry-level plan with Talk to Aura (Text-Based), Social Signal, and Aura Web Presence.',
    highlights: [
