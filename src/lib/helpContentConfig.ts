...
export const CONSOLE_HELP_CONFIG: ConsoleHelpConfig[] = [
  {
    ...
    icon: HeadphonesIcon,
    description: 'AI customer engagement hub with Message Aura (Text), Talk to Aura (Voice), automated scheduling, follow-ups, and review collection — all in one Customer Journey Agent.',
  ...
  },
  {
    ...
    icon: Megaphone,
    description: 'AI marketing automation — all in one Outreach Agent covering campaign management, lead nurturing, customer segmentation, and promotional tools.',
    requiredTier: 'starter',
  ...
  },
  {
    ...
    icon: Share2,
    description: 'AI creative studio powered by the Creative Content Agent — generates platform-optimized posts, AI images/videos, and multi-channel content for 6 platforms.',
    requiredTier: 'connect',
    ...
    features: [
      ...
      { text: 'AI content rewording and variations' },
      ...
      { text: 'Web Presence Manager with AI website and blog', tier: 'connect' },
  ...
  },
  {
    ...
    icon: Palette,
    description: 'AI content generation and web management hub with Creative Content Agent + Web Presence Agent.',
    requiredTier: 'starter',
    ...
    features: [
      ...
      { text: 'AI content variations and rewording' },
