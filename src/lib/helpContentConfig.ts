...
export const CONSOLE_HELP_CONFIG: ConsoleHelpConfig[] = [
  ...
  },
  {
    ...
    agents: [
      { name: 'Aura Social Signal Agent', tier: 'command' },
      { name: 'Aura Signal Scheduler', tier: 'command' },
      { name: 'Aura Signal Analytics', tier: 'command' },
    ],
    features: [
...
export const TIER_HELP_DESCRIPTIONS: Record<SubscriptionTier, { title: string; description: string; highlights: string[] }> = {
  ...
  command: {
    ...
    highlights: [
      ...
      'Aura Social Signal Ops (6 platforms)',
