    ...
    clips: [
      {
        ...
        prompt: 'All 10 AI operative icons arranging themselves in a grand neural network formation. Connection lines pulse between agents showing real-time handoffs. A central command node monitors all agents simultaneously. Batch activation switches toggle with cascade effects. Indigo and white holographic command center on dark background. 4K cinematic.',
        audioScript: 'The AI Operatives Hub is mission control for all 10 operatives — activate, monitor, and coordinate your entire AI workforce from one screen.',
        imagePrompt: 'Grand neural network of 10 AI operative icons connected with pulsing lines. Central command node monitoring all agents. Batch activation panel. "AI OPERATIVES HUB — Aura Intercept" label. Indigo and white holographic command center, dark background.',
      },
    ],
  },
  {
    ...
    clips: [
      {
        ...
        prompt: 'The full Aura Intercept neural network zooming out to reveal the complete 10-operative ecosystem connected across 7 consoles. The network pulses with activity as the tagline "Your AI Operating System" materializes in bold typography. The Aura Intercept logo locks in center frame with a final energy pulse. Deep blue, cyan, and gold premium palette. 4K cinematic.',
        audioScript: 'Aura Intercept. Seven consoles. Ten operatives. One platform. Your AI operating system is ready.',
        imagePrompt: 'Full Aura Intercept ecosystem zoomed out: all 7 console icons connected to 10 operative nodes in one unified glowing network. Tagline "Your AI Operating System" in large futuristic type. Aura Intercept logo centered with energy pulse ring. Deep blue, cyan, and gold premium brand poster. 4K.',
      },
    ],
  },
];
