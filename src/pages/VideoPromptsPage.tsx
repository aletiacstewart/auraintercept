    ...
    clips: [
      {
        ...
        imagePrompt: 'Grand neural network of 24 AI operative icons connected with pulsing lines. Central command node monitoring all agents. Batch activation panel. "AI OPERATIVES HUB — Aura Intercept" label. Indigo and white holographic command center, dark background.',
      },
    ],
  },
  {
    ...
    clips: [
      {
        ...
        audioScript: 'Aura Intercept. Seven consoles. Twenty-four operatives. One platform. Your AI operating system is ready.',
