...
{/* 4 Tier Rows - Compact Single Line */}
                <div className="space-y-1">
                  {[
                    ...
                    { id: 'command',     name: 'Aura Elite', sub: 'Full Suite • Enterprise • Unlimited',           originalMonthly: '$3,997', monthlyPrice: '$2,997', annualPrice: '$2,581', annualTotal: '$29,970', savings: '$5,994', color: 'amber', popular: false },
                  ].map(t => (
                    <div
                      key={t.id}
