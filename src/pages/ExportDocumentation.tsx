            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  { page: 6, title: 'Boost Details', desc: '$994/mo (was $1,394) tier breakdown' },
                  { page: 7, title: 'Pro Details', desc: '$1,988/mo (was $2,788) tier breakdown' },
                  { page: 8, title: 'Elite Details', desc: '$3,979/mo (was $5,576) tier breakdown' },
