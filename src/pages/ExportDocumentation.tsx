            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  { page: 6, title: 'Boost Details', desc: '$1,097/mo tier breakdown' },
                  { page: 7, title: 'Pro Details', desc: '$1,997/mo tier breakdown' },
                  { page: 8, title: 'Elite Details', desc: '$3,497/mo tier breakdown' },
