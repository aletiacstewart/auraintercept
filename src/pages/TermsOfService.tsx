        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>Subscription plans range from $697 to $3,497 per month across 4 tiers (Aura Core, Aura Boost, Aura Pro, and Aura Elite).</li>
              <li>Employee accounts vary by tier (10–Unlimited included). Additional employees: $25/month per 10 employees.</li>
              <li><strong className="text-foreground">One-time onboarding fee</strong> is due at the start of your 90-Day Live Trial: Aura Core $697, Aura Boost $1,097, Aura Pro $1,997, Aura Elite $3,497. Onboarding fees are non-refundable once onboarding is completed.</li>
