...
const featureDescriptions: Record<string, string> = {
  ...
  'Web Presence Agent': 'AI website and blog management. Auto-optimizes SEO, monitors site performance, and auto-publishes blog posts.',
...
const sections: FeatureSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Onboarding Fee (25% OFF — Beta)', starter: '~~$497~~ $370', connect: '~~$994~~ $750', performance: '~~$1,988~~ $1,490', command: '~~$3,979~~ $2,980' },
    ],
  },
];
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">
                  Onboarding Fee (one-time, due at start of 60-Day Live Trial) — <span className="text-foreground font-semibold">equals 1 month of your plan, 25% OFF during Beta</span>: Core <span className="line-through">$497</span> $370 · Boost <span className="line-through">$994</span> $750 · Pro <span className="line-through">$1,988</span> $1,490 · Elite <span className="line-through">$3,979</span> $2,980.
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-border/50 bg-card">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                <span className="text-primary font-semibold">Beta Pricing:</span> Aura Intercept ships 24 AI agents organized into 10 Operatives. Core (was $697 → <span className="font-semibold">$497/mo</span>) includes 5 AI Operatives — ideal for solo operators and restaurants. Boost (was $1,394 → <span className="font-semibold">$994/mo</span>) adds Dispatch and Field Navigation — perfect for HVAC, plumbing, and field service. Pro (was $2,788 → <span className="font-semibold">$1,988/mo</span>) unlocks all 24 AI Operatives plus Business Finance and Analytics. Elite (was $5,576 → <span className="font-semibold">$3,979/mo</span>) is the full suite — all 24 AI Operatives (organized into 10 operative roles) plus predictive analytics and the AI Operatives Hub for enterprise teams. Industry Specialist Operatives (Diagnostic, Permit & Code, Site Survey, Insurance Claim, Listing Writer, Recall, Menu Writer, etc.) auto-activate based on your industry on every plan — including the 60-Day Live Trial.
              </p>
            </div>
            <div>
