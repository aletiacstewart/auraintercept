...
const featureDescriptions: Record<string, string> = {
  ...
  'Aura Social Signal Agent': 'Creates, schedules, and publishes social media content to grow your online presence.',
...
const TIERS = [
  ...
  },
  {
    ...
    highlights: [
      ...
      '5 Employee Accounts',
      'Choice: Aura Social Signal or Aura Web Presence',
    ],
  },
  {
    id: 'multi_track',
