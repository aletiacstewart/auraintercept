...
const featureDescriptions: Record<string, string> = {
  ...
  'Social Media Signal Agent': 'Creates, schedules, and publishes social media content to grow your online presence.',
...
const TIERS = [
  ...
  },
  {
    ...
    description: 'Talk to Aura + Social Media Signal + Aura Web Presence',
    popular: false,
    agentCount: 0,
    consoleCount: 0,
    highlights: [
...
const sections: FeatureSection[] = [
  {
    ...
    features: [
      ...
      { name: 'Social Media Signal Agent', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
