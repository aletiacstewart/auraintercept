...
const agents = [
  { name: "Scheduling Agent", desc: "Handles booking, rescheduling & cancellations", icon: Calendar, status: "active", confidence: 96 },
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 24px 100px" }}>
        ...
        <div style={{
          ...
          <div style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(180deg, rgba(4,10,20,0.5) 0%, rgba(4,10,20,0.3) 40%, rgba(4,10,20,0.85) 100%)",
          }} />
