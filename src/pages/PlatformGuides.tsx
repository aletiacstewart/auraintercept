...
const NAVIGATION_ROUTES: Record<string, string> = {
  ...
  'Analytics & Reports Console': '/dashboard/analytics',
  'Analytics Console': '/dashboard/analytics',
  ...
  'Platform Resources → AI Agent Guide': '/dashboard/ai-agents',
  'AI Agent Guide': '/dashboard/ai-agents',
