...
const PRICING_TIERS = [
  { name: 'Aura Core', originalPrice: '$697', price: '$497', tagline: '8 agents · 3 consoles', tier: 'starter' },
  { name: 'Aura Boost', originalPrice: '$1,097', price: '$897', tagline: '12 agents · 5 consoles', tier: 'connect' },
  { name: 'Aura Pro', originalPrice: '$1,997', price: '$1,797', tagline: '16 agents · 5 consoles', tier: 'performance' },
  { name: 'Aura Elite', originalPrice: '$3,997', price: '$2,997', tagline: '24 agents · 7 consoles + AI Hub', tier: 'command' },
] as const;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO
        ...
        description="Pick your industry to preview a tailored AI receptionist, dispatcher, and marketer with a 24-hour live demo."
        path="/for-business"
      />
      <PublicHeader />
        ...
        <div className="container max-w-6xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <span className="text-xs text-muted-foreground">
              Pick Your Industry from the dropdown and start a 24-hour demo.
            </span>
          </div>
        ...
        <section className="py-10 bg-gradient-to-br from-primary/15 via-background to-secondary/15">
          <div className="container max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              24 hours. Full access. Owner, technician, and customer views — all yours.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button size="lg" variant="gradient" onClick={() => setDemoOpen(true)}>
                <Sparkles className="w-5 h-5" /> Start your 24-hour demo
              </Button>
