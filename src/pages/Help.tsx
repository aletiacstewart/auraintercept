...
export default function Help() {
  ...
  const effectiveTier: SubscriptionTier = inTrial || isPlatformAdmin ? 'command' : (subscriptionTier || 'field_ops');
                    ...
                    <div className="space-y-4 ml-7">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-card-foreground/70">Visit the sign-in page and select "Company Sign Up" to create your company account. You'll receive a 30-day free trial with full access to all features.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <Badge variant="outline" className="h-6 w-6 rounded-full p-0 flex items-center justify-center flex-shrink-0">2</Badge>
                    ...
                    <AccordionItem value="trial">
                      ...
                      <AccordionContent>
                        <p className="text-card-foreground/70">
                          Your 30-day free trial includes <strong className="text-card-foreground">full access to all Aura Pro Command tier features</strong>. This means all 24 AI agents, all 7 Control Centers, and all platform features. After your trial ends, you'll be prompted to select a subscription plan.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                      ...
                      <AccordionContent>
                        <div className="text-card-foreground/70 space-y-3">
                          <ul className="space-y-3 text-sm">
                            ...
                            <li>
                      <strong className="text-card-foreground">Aura Pro Command ($3,497/mo):</strong>
