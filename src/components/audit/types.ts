...
export const TIER_RECOMMENDATIONS: Record<TierType, TierRecommendation> = {
  CORE: {
    ...
    implementationFee: '$0 during Beta (waived); regular $497 one-time',
  },
  BOOST: {
    tier: 'BOOST',
    label: 'Aura Boost',
    ...
    implementationFee: '$0 during Beta (waived); regular $994 one-time',
  },
  PRO: {
    tier: 'PRO',
    label: 'Aura Pro',
    ...
    implementationFee: '$0 during Beta (waived); regular $1,988 one-time',
  },
  ELITE: {
    tier: 'ELITE',
    label: 'Aura Elite',
    price: '$3,979/mo (Beta Pricing — was $5,576)',
    description: 'All 24 AI Operatives (organized into 10 operative roles) — adds Billing (quotes, invoices, inventory) and full Reports for large teams & enterprise operations.',
    keyFeatures: [
    ...
    implementationFee: '$0 during Beta (waived); regular $3,979 one-time',
  },
};
