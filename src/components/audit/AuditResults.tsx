    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-xs text-muted-foreground text-center mt-8 max-w-lg mx-auto">
          ...
          All plans include a 90-Day Live Trial — the first 30 days are dedicated to onboarding, then 60 days of full live use. One-time onboarding fees (due at start of trial): $497 (Core), $697 (Boost), $1,197 (Pro), $2,197 (Elite).
        </p>
      </div>
    </div>
  );
