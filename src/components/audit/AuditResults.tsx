    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-xs text-muted-foreground text-center mt-8 max-w-lg mx-auto">
          ...
          All plans include a 60-Day Live Trial — the first 30 days are dedicated to onboarding, then 30 days of full live use. Onboarding fee: $0 during Beta (waived automatically). Regular one-time onboarding fee (1 month of plan) — Core $497, Boost $994, Pro $1,988, Elite $3,979 — invoiced on day 31, non-refundable. First monthly plan fee charged on day 61.
        </p>
      </div>
    </div>
  );
