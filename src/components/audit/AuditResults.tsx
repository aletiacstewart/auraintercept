    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-xs text-muted-foreground text-center mt-8 max-w-lg mx-auto">
          ...
          All plans include a 60-Day Live Trial — the first 30 days are dedicated to onboarding, then 30 days of full live use. One-time onboarding fees (due at start of trial): $497 (Core), $497 (Boost), $497 (Pro), $497 (Elite).
        </p>
      </div>
    </div>
  );
