    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <FAQItem 
          ...
          answer={`One-time implementation fees vary by tier: Core ($${SUBSCRIPTION_TIERS.aura_core?.implementationFee ?? 199}), Boost ($${SUBSCRIPTION_TIERS.aura_boost?.implementationFee ?? 399}), Pro ($${SUBSCRIPTION_TIERS.aura_pro?.implementationFee ?? 599}), and Elite ($${SUBSCRIPTION_TIERS.aura_elite?.implementationFee ?? 799}). This covers initial setup, configuration, and training.`}
        />
