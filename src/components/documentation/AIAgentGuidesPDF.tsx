...
const CONSOLES = [
  ...
  },
  {
    ...
    agents: [
      ...
      {
        name: 'Promo Agent',
        description: 'Creates and manages promotional codes, seasonal discounts, and special offers. Tracks redemption and ROI.',
        isCore: false,
        worksAlone: false,
...
const TIERS = [
  {
    ...
    voiceIncluded: true,
    note: 'Specialized for salons & wellness. Includes AI Receptionist, Scheduling, Follow-up, plus Talk to Aura (Voice).',
  },
  {
    name: 'Aura Core',
    price: '$500/month',
