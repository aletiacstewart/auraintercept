...
const TIERS = [
  ...
  },
  {
    ...
    consoles: [`${SUBSCRIPTION_TIERS.aura_pro?.consoles ?? 6} Consoles`],
    agentCount: SUBSCRIPTION_TIERS.aura_pro?.operatives ?? 18,
    agents: ['All Boost Agents', 'Campaign Agent', 'Outreach Agent', 'Social Feed Queue', 'Social Analytics', 'Admin Agent', 'Quoting Agent'],
    voiceIncluded: SUBSCRIPTION_TIERS.aura_pro?.hasVoice ?? true,
    note: SUBSCRIPTION_TIERS.aura_pro?.description ?? '18 Smart AI Agents with social media, admin & white-label branding.',
  },
  {
