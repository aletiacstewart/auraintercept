...
// Subscription tiers - pulled from centralized config
const TIERS = [
  {
    name: SUBSCRIPTION_TIERS.express.name,
    price: `$${SUBSCRIPTION_TIERS.express.price}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.express.annualPrice.toLocaleString()}/year`,
    consoles: ['None (Voice & Chat Only)'],
    agentCount: SUBSCRIPTION_TIERS.express.operatives,
    agents: ['Talk to Aura (Voice)', 'Message Aura (Text)', 'Smart Link Sharing'],
    voiceIncluded: SUBSCRIPTION_TIERS.express.hasVoice,
    note: SUBSCRIPTION_TIERS.express.description,
  },
  {
    name: SUBSCRIPTION_TIERS.aura_flow.name,
    price: `$${SUBSCRIPTION_TIERS.aura_flow.price}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.aura_flow.annualPrice.toLocaleString()}/year`,
    consoles: ['None (Calendar Sync Only)'],
    agentCount: SUBSCRIPTION_TIERS.aura_flow.operatives,
    agents: ['AI Receptionist', 'Scheduling Agent', 'Follow-up Agent'],
    voiceIncluded: SUBSCRIPTION_TIERS.aura_flow.hasVoice,
    note: SUBSCRIPTION_TIERS.aura_flow.description,
  },
  {
    name: SUBSCRIPTION_TIERS.halo.name,
    price: `$${SUBSCRIPTION_TIERS.halo.price}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.halo.annualPrice.toLocaleString()}/year`,
    consoles: [`${SUBSCRIPTION_TIERS.halo.consoles} Console: Customer Portal`],
    agentCount: SUBSCRIPTION_TIERS.halo.operatives,
    agents: ['AI Receptionist (Triage)', 'Scheduling Agent', 'Follow-up Agent'],
    voiceIncluded: SUBSCRIPTION_TIERS.halo.hasVoice,
    note: SUBSCRIPTION_TIERS.halo.description,
  },
  {
    name: SUBSCRIPTION_TIERS.core.name,
    price: `$${SUBSCRIPTION_TIERS.core.price}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.core.annualPrice.toLocaleString()}/year`,
    consoles: [`${SUBSCRIPTION_TIERS.core.consoles} Consoles`],
    agentCount: SUBSCRIPTION_TIERS.core.operatives,
    agents: ['Message Aura (Text)', 'Social Media Console', 'Web Presence Console', 'Creative Agent'],
    voiceIncluded: SUBSCRIPTION_TIERS.core.hasVoice,
    note: SUBSCRIPTION_TIERS.core.description,
  },
  {
    name: SUBSCRIPTION_TIERS.single_point.name,
    price: `$${SUBSCRIPTION_TIERS.single_point.price.toLocaleString()}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.single_point.annualPrice.toLocaleString()}/year`,
    consoles: [`Up to ${SUBSCRIPTION_TIERS.single_point.consoles} Consoles`],
    agentCount: SUBSCRIPTION_TIERS.single_point.operatives,
    agents: ['AI Receptionist (Triage)', 'Follow-up Agent', 'Review Agent', 'Choice of Social Media OR Web Presence'],
    voiceIncluded: SUBSCRIPTION_TIERS.single_point.hasVoice,
    note: SUBSCRIPTION_TIERS.single_point.description,
  },
  {
    name: SUBSCRIPTION_TIERS.multi_track.name,
    price: `$${SUBSCRIPTION_TIERS.multi_track.price.toLocaleString()}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.multi_track.annualPrice.toLocaleString()}/year`,
    consoles: [`Up to ${SUBSCRIPTION_TIERS.multi_track.consoles} Consoles`],
    agentCount: SUBSCRIPTION_TIERS.multi_track.operatives,
    agents: [
      'AI Receptionist', 'Scheduling Agent', 'Follow-up Agent', 'Review Agent',
      'Dispatch Agent', 'Route Agent', 'ETA Agent', 'Check-in Agent',
      'Quoting Agent', 'Invoice Agent', 'Social Media', 'Creative Agent',
    ],
    voiceIncluded: SUBSCRIPTION_TIERS.multi_track.hasVoice,
    note: SUBSCRIPTION_TIERS.multi_track.description,
  },
  {
    name: SUBSCRIPTION_TIERS.command.name,
    price: `$${SUBSCRIPTION_TIERS.command.price.toLocaleString()}/month`,
    annualPrice: `$${SUBSCRIPTION_TIERS.command.annualPrice.toLocaleString()}/year`,
    consoles: [`All ${SUBSCRIPTION_TIERS.command.consoles} Consoles`],
    agentCount: SUBSCRIPTION_TIERS.command.operatives,
    agents: [`All ${SUBSCRIPTION_TIERS.command.operatives} AI Operatives`],
    voiceIncluded: SUBSCRIPTION_TIERS.command.hasVoice,
    note: SUBSCRIPTION_TIERS.command.description,
  },
];
