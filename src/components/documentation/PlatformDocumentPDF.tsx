  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.pricingCard}>
        ...
        <Text style={styles.pricingFeature}>- $349 one-time onboarding fee (due at start of 90-Day Live Trial; first 30 days = onboarding)</Text>
      </View>
      ...
      <View style={styles.pricingCard}>
        ...
        <Text style={styles.pricingFeature}>- $549 one-time onboarding fee (due at start of 90-Day Live Trial; first 30 days = onboarding)</Text>
      </View>
      ...
      <View style={[styles.pricingCard, { borderWidth: 2, borderColor: colors.primary }]}>
        ...
        <Text style={styles.pricingFeature}>- $999 one-time onboarding fee (due at start of 90-Day Live Trial; first 30 days = onboarding)</Text>
      </View>
      ...
      <View style={styles.pricingCard}>
        ...
        <Text style={styles.pricingFeature}>- $1,749 one-time onboarding fee (due at start of 90-Day Live Trial; first 30 days = onboarding)</Text>
      </View>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.agentCard}>
        ...
        <Text style={styles.agentDescription}>
          ...
          that's $6,000/month in lost revenue. Aura Core starts at $349/month — and there's a 90-Day Live Trial with no credit card required (first 30 days are dedicated to onboarding, then 60 days of full live use)."
        </Text>
      </View>
