  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.roiCard}>
        <Text style={styles.roiTitle}>ROI Calculator: Aura Boost Tier ($897/mo)</Text>
        ...
        <View style={styles.column}>
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$1,797/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$1,797</Text>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.dataCard}>
        ...
        <VisualDataRow label="Aura Elite Tier" value={57} display="$21,564" color={colors.primary} />
        <VisualDataRow label="Aura Pro Tier" value={28} display="$11,964" color={colors.secondary} />
        <VisualDataRow label="Aura Boost Tier" value={14} display="$10,764" color={colors.accent} />
