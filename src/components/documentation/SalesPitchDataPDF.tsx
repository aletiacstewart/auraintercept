  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.roiCard}>
        <Text style={styles.roiTitle}>ROI Calculator: Aura Boost Tier ($994/mo)</Text>
        ...
        <View style={styles.roiRow}>
          ...
          <Text style={styles.roiValue}>-$994</Text>
        </View>
        ...
        <View style={styles.column}>
          ...
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$994/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$994</Text>
        ...
        <View style={styles.column}>
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$1,988/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$1,988</Text>
          ...
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$3,979/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$3,979</Text>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.dataCard}>
        <View style={styles.comparisonTable}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={[styles.tableCell, styles.tableCellBold, { color: colors.success }]}>$497-$3,979</Text>
      ...
      <View style={styles.dataCard}>
        ...
        <VisualDataRow label="Aura Elite Tier" value={57} display="$23,856" color={colors.primary} />
        <VisualDataRow label="Aura Pro Tier" value={28} display="$11,964" color={colors.secondary} />
        <VisualDataRow label="Aura Boost Tier" value={14} display="$11,928" color={colors.accent} />
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.objectionCard}>
        ...
        <Text style={styles.responseText}>
          ...
          Start your 60-day trial today. Full access to [tier]. First 30 days = onboarding (we configure everything for you), then 30 days of full live use. The one-time onboarding fee is due at trial start and is non-refundable; cancel any time during the live-use window before your first monthly subscription charge.{'\n\n'}
