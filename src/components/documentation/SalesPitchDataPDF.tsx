    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.closingCard}>
        ...
        <Text style={styles.closingText}>
          "Based on what you've shared about your business—[recap their situation]—I'd recommend starting with [Tier]. It addresses your immediate need for [primary pain point] while giving you room to grow. Should I walk you through the 60-day trial?"
        </Text>
      </View>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.objectionCard}>
        ...
        <Text style={styles.responseText}>
          ...
          Start your 60-day trial today. Full access to [tier]. If after two weeks you don't see the value—if you're not capturing more leads and saving time—you pay nothing.{'\n\n'}
