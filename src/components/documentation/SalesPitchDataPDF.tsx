  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.roiCard}>
        <Text style={styles.roiTitle}>ROI Calculator: Aura Boost Tier ($697/mo)</Text>
        ...
        <View style={styles.column}>
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$1,197/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$1,197</Text>
          ...
          <View style={styles.tierCard}>
            <View style={styles.tierHeader}>
              ...
              <Text style={styles.tierPrice}>$2,197/mo</Text>
            </View>
            ...
            <Text style={styles.tierBullet}>- Cost: -$2,197</Text>
      ...
      <View style={styles.dataCard}>
        <View style={styles.comparisonTable}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={[styles.tableCell, styles.tableCellBold, { color: colors.success }]}>$497-$2,197</Text>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.tierCard}>
        ...
        <Text style={styles.tierBullet}>- Industry Specialist Agents included</Text>
      ...
      <View style={styles.closingCard}>
        ...
        <Text style={styles.closingText}>
          "Based on what you've shared about your business—[recap their situation]—I'd recommend starting with [Tier]. It addresses your immediate need for [primary pain point] while giving you room to grow. Should I walk you through the 90-day trial?"
        </Text>
      </View>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.objectionCard}>
        ...
        <Text style={styles.responseText}>
          ...
          Start your 90-day trial today. Full access to [tier]. If after two weeks you don't see the value—if you're not capturing more leads and saving time—you pay nothing.{'\n\n'}
