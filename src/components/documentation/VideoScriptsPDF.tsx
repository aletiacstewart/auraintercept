    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.scriptCard}>
        ...
        <View style={styles.timestampRow}>
          ...
          <Text style={styles.timestampContent}>[Solution Intro] "Aura Intercept is your AI-powered business command center. 10 AI Operatives working 24/7 to capture every lead and keep your business running."</Text>
        </View>
        <View style={styles.timestampRow}>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.scriptCard}>
        ...
        <View style={styles.timestampRow}>
          ...
          <Text style={styles.timestampContent}>[CTA] "Transform your customer experience today. Start with Aura Core at just $697/month. Every call answered. Every customer impressed."</Text>
        </View>
      </View>
      ...
      <View style={styles.scriptCard}>
        ...
        <View style={styles.scriptSection}>
          ...
          <Text style={styles.scriptText}>
            ...
            Starting at $1,097/month. Most customers see ROI in week one.{'\n\n'}
