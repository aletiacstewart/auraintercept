    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.scriptCard}>
        ...
        <View style={styles.timestampRow}>
          ...
          <Text style={styles.timestampContent}>[Solution Intro] "Aura Intercept is your AI business command center. 24 AI Operatives working 24/7 to capture every lead and keep your business running."</Text>
        </View>
        <View style={styles.timestampRow}>
