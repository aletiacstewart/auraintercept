  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.faqCard}>
        ...
        <Text style={styles.faqAnswer}>Simple, transparent pricing. Your monthly subscription includes all features for your tier. There's a one-time onboarding fee equal to one month of your plan, with 50% OFF during Beta — due at the start of your 60-Day Live Trial: Core $249 (was $497), Boost $497 (was $994), Pro $994 (was $1,988), Elite $1,990 (was $3,979). The first 30 days of the trial are your onboarding window — setup, training, and customization — then 30 days of full live use. 3rd-party usage (SignalWire voice/SMS, ElevenLabs, Resend, Tavily, Stripe, A2P 10DLC, social) is pay-as-you-go and billed directly by each vendor to your own credit card on a per-use basis (per minute, per text, per email, per search, per transaction) — including during the trial. Aura never resells or marks up vendor charges.</Text>
      </View>
