...
const TOS_CLAUSES: Array<{ title: string; body: string }> = [
  ...
  { title: '3. Onboarding Fee', body: 'A one-time flat $497 onboarding fee applies to every tier (Core, Boost, Pro, and Elite). It is due at the start of the 60-Day Live Trial and is non-refundable once onboarding begins. The fee covers Concierge Onboarding services and platform configuration.' },
...
const TermsAcknowledgementPage = () => {
  const ackItems = [
    ...
    'I agree to the 60-Day Live Trial terms; the flat $497 onboarding fee (same for every tier) is due at the start of the trial and is non-refundable once onboarding begins.',
