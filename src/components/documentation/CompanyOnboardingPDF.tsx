...
const TermsAcknowledgementPage = () => {
  const ackItems = [
    ...
    'I agree to the 60-Day Live Trial terms; the one-time onboarding fee is $0 during Beta (waived automatically), the regular fee (1 month of plan — Core $497 / Boost $994 / Pro $1,988 / Elite $3,979) would be invoiced on day 31 of the trial and is non-refundable, and my first monthly plan fee is charged on day 61.',
