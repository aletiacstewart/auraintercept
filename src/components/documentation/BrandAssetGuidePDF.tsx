        ...
        <View style={styles.column}>
          <View style={styles.colorCard}>
            ...
            <ColorSwatch 
              ...
              hex="#3b82f6" 
              usage="Aura Boost tier ($697/mo)"
            />
            <ColorSwatch 
              color="#8b5cf6" 
              name="Aura Pro Purple" 
              hex="#8b5cf6" 
              usage="Aura Pro tier ($1,197/mo)"
            />
            <ColorSwatch 
              color="#f59e0b" 
              name="Aura Elite Gold" 
              hex="#f59e0b" 
              usage="Aura Elite tier ($2,197/mo)"
            />
          </View>
        </View>
      </View>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.typographyCard}>
        ...
        <View style={{ marginBottom: 0 }}>
          ...
          <Text style={[styles.fontDisplay, { fontFamily: 'Courier', fontSize: 18 }]}>$697-$2,197/month</Text>
