      ...
      <CardContent>
        ...
        <div className="flex flex-wrap gap-4 mt-4 justify-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-card-foreground">Boost ($697/mo)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded bg-violet-600" />
            <span className="text-sm text-card-foreground">Pro ($1,197/mo)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded bg-amber-600" />
            <span className="text-sm text-card-foreground">Elite ($2,197/mo)</span>
          </div>
        </div>
      </CardContent>
    </Card>
