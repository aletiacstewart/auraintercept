...
const featureDescriptions: Record<string, string> = {
  ...
  'Customer Portal': 'Where your customers book, message, and pay — 24 hours a day, no phone tag.',
  'Outreach & Sales': 'Capture leads, score them, and run the campaigns that turn them into jobs.',
...
const sections: FeatureSection[] = [
  {
    ...
    features: [
      ...
      {
        name: 'Industry Plan Suggestions',
  ...
  },
  {
    ...
    subtitle: 'Auto-activated based on the industry you select at signup. Included on every plan.',
    features: [
      { name: 'Diagnostic Agent', starter: 'check', connect: 'check', performance: 'check', command: 'check' },
      { name: 'Permit & Code Agent', starter: 'check', connect: 'check', performance: 'check', command: 'check' },
      { name: 'Site Survey & Quote Agent', starter: 'check', connect: 'check', performance: 'check', command: 'check' },
      { name: 'Insurance Claim Agent', starter: 'check', connect: 'check', performance: 'check', command: 'check' },
    ],
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Voice, SMS, email, and web chat run on your own provider accounts — each provider bills you directly, separate from your Aura plan.',
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'One-Time Onboarding Fee', starter: '~~$497~~ Waived (beta)', connect: '~~$994~~ Waived (beta)', performance: '~~$1,988~~ Waived (beta)', command: '~~$3,979~~ Waived (beta)' },
    ],
  },
];
...
const renderValue = (
  ...
  // Note: do not use 'Bundled' as a value — Aura never bundles 3rd-party usage.
  // Only 'Included' (a platform feature) gets the green highlight.
  ...
  else if (isIncluded) textClass = 'text-emerald-400 text-xs font-medium';
        ...
        <thead>
          <tr className="border-b border-white/20 bg-slate-700/80">
            ...
            <th className="text-center py-2.5 px-2 font-semibold bg-sky-600/40 border-x border-sky-400/50 text-xs">
              ...
              <div className="text-[10px] font-normal text-cyan-300/70"><span className="line-through opacity-70">$1,394</span> $994/mo · 12 agents</div>
            </th>
            <th className="text-center py-2.5 px-2 font-semibold bg-purple-500/20 border-x border-purple-400/30 text-xs">
              ...
              <div className="text-[10px] font-normal text-purple-300/70"><span className="line-through opacity-70">$2,788</span> $1,988/mo · 16 agents</div>
            </th>
            <th className="text-center py-2.5 px-2 font-semibold bg-amber-500/20 border-x border-amber-400/30 text-xs">
              ...
              <div className="text-[10px] font-normal text-amber-300/70"><span className="line-through opacity-70">$5,576</span> $3,979/mo · 24</div>
            </th>
          </tr>
        </thead>
