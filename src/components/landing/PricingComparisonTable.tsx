...
const featureDescriptions: Record<string, string> = {
  ...
  'Service Delivery Console': 'Real-time console to schedule, assign, and track jobs, visits, and appointments across every staff role.',
  ...
  'Talk to Aura (Voice)': 'Speech-based AI conversations using microphone and speakers. Voice infrastructure (ElevenLabs + SignalWire) is bundled in every plan — no separate accounts required.',
...
const sections: FeatureSection[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Service Delivery Console', starter: 'check', connect: 'check', performance: 'check', command: 'check' },
  ...
  },
  {
    ...
    subtitle: 'Voice, SMS, email, and web chat are bundled in every plan.',
    features: [
