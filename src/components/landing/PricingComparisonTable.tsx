...
const featureDescriptions: Record<string, string> = {
  ...
  'Aura Social Signal Agent': 'AI-powered content creation for all social platforms.',
  'Aura Signal Scheduler': 'Automated post scheduling across 6 platforms.',
  'Aura Signal Analytics': 'Engagement metrics and performance tracking.',
...
const sections: FeatureSection[] = [
  {
    ...
    features: [
      ...
      { name: 'Aura Social Signal Agent', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
      { name: 'Aura Signal Scheduler', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
      { name: 'Aura Signal Analytics', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
