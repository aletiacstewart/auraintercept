...
const featureDescriptions: Record<string, string> = {
  ...
  'Creative Content Agent': 'AI-powered content creation for Facebook, Instagram, LinkedIn, TikTok, Google Business, and SMS.',
  'Social Feed Queue': 'Content calendar management across 6 platforms. AI generates ready-to-post content.',
