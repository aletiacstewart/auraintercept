...
const featureDescriptions: Record<string, string> = {
  ...
  'Social Signal Agent': 'AI-powered content creation for all social platforms.',
  ...
  'Social Signal Console': 'Unified dashboard to manage all your social media accounts and content calendar.',
...
const sections: FeatureSection[] = [
  {
    ...
    features: [
      ...
      { name: 'Social Signal Agent', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
      { name: 'Signal Scheduler', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
      { name: 'Signal Analytics', core: 'x', singlePoint: 'x', multiTrack: 'x', command: 'check' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Web Presence', core: 'check', singlePoint: 'Choice of 1', multiTrack: 'check', command: 'check' },
      { name: 'Social Signal', core: 'check', singlePoint: 'Choice of 1', multiTrack: 'check', command: 'check' },
