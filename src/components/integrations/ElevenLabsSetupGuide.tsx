              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4 bg-background">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/30 p-2 rounded flex items-center gap-2">
                    <span className="text-xs text-blue-800 dark:text-cyan-200">
          ...
          <AccordionItem value="step-3">
            ...
            <AccordionContent className="text-sm text-muted-foreground space-y-4">
              <Alert className="bg-blue-50 dark:bg-blue-950/30 border-blue-200">
                ...
                <AlertDescription className="text-xs text-blue-800 dark:text-cyan-200">
                              ...
                              <div className="space-y-2">
                                ...
                                {param.valueType === 'value' && param.value && (
                                  <div className="flex items-center gap-2 bg-blue-50 dark:bg-blue-950/30 p-2 rounded">
                                    ...
                                    <code className="text-xs bg-white dark:bg-blue-900/50 px-2 py-1 rounded flex-1 font-mono text-blue-800 dark:text-cyan-200 break-all">{param.value}</code>
                                    <Button
                                      variant="secondary"
                                      size="sm"
