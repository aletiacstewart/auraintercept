      ...
      {actions.map((action) => (
        <Button
          ...
          className={cn(
            ...
            'bg-muted border-border text-foreground hover:bg-muted/80 hover:border-primary/50 transition-colors',
      ...
      <div className="flex gap-1.5 overflow-x-auto scrollbar-hide pb-1">
        {actions.map((action) => (
          <Button
            ...
            size="sm"
            className={cn(
              'text-xs shrink-0 rounded-full px-3 h-8 text-muted-foreground',
