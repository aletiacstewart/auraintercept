...
interface CreateTestEmployeesProps {
  companyId: string;
}

export function CreateTestEmployees({ companyId }: CreateTestEmployeesProps) {
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-white/70">
          Create test employee accounts. Default password: Test123!
        </CardDescription>
      </CardHeader>
