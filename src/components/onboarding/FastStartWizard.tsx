  ...
  const renderStep0 = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          You're on the <span className="font-semibold text-primary">{tierInfo.label}</span> plan with a 30-day free trial. Pick your business type so Aura can tailor everything.
        </CardDescription>
      </CardHeader>
