  ...
  const renderStep0 = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          You're on the <span className="font-semibold text-primary">{tierInfo.label}</span> plan with a 60-Day Live Trial (first 30 days = onboarding, then 30 days of full live use). Pick your business type so Aura can tailor everything.
        </CardDescription>
      </CardHeader>
