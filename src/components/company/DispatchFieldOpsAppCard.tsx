...
import {
  Map, Download, Share, Plus, MoreVertical,
...
export function DispatchFieldOpsAppCard() {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-3 grid-cols-3 pt-2 border-t border-border/50">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-xs text-card-foreground/70">Live Tracking</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <div className="h-8 w-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-xs text-card-foreground/70">Real-time ETA</span>
          </div>
        </div>
      </CardContent>
    </Card>
