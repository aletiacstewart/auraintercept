...
export const VoiceStatusIndicator = forwardRef<HTMLDivElement, VoiceStatusIndicatorProps>(
  function VoiceStatusIndicator({ size = 'md', showLabel = false, className }, ref) {
