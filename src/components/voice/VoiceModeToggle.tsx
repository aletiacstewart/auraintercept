...
VoiceModeToggle.displayName = 'VoiceModeToggle';

export const VoiceModeBadge = forwardRef<HTMLDivElement, {}>(
  function VoiceModeBadge(_props, ref) {
...
VoiceModeBadge.displayName = 'VoiceModeBadge';
