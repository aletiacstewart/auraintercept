        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-foreground mt-1">
            {isCritical 
              ...
              : "You have full access to every Aura Elite feature during your 60-Day Live Trial. The first 30 days are your concierge onboarding window; the remaining 30 days are your full live use."
            }
          </p>
