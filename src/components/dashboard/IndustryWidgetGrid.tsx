...
const WIDGET_REGISTRY: Record<string, WidgetSpec> = {
  ...
  lead_scoring: { label: 'Lead Scoring', icon: Activity,
    ...
    cta: { label: 'View leads', route: '/leads' } },
