...
export function CompanyAdminDashboard() {
  ...
  const allStatCards = [
    ...
    { title: 'Social Posts', value: stats?.totalSocialPosts ?? 0, icon: Share2, description: `${stats?.publishedSocialPosts ?? 0} published, ${stats?.scheduledSocialPosts ?? 0} scheduled`, colorClass: 'bg-feature-marketing/15 text-feature-marketing', href: '/dashboard/ai-consoles/social-media', requiredTier: 'command' as SubscriptionTier },
