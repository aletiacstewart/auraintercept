        ...
        <div ref={sidebarScrollRootRef} className="flex-1 min-h-0">
            ...
            <nav className="space-y-2 px-2 py-2">
              {filteredNavGroups.map((group) => (
                <div key={group.label} className="space-y-1">
                  {!collapsed && (
                    <p className="px-3 py-0.5 text-xs font-semibold uppercase tracking-wider" style={{ color: "rgba(0,229,255,0.35)" }}>
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <Button
                        ...
                        data-tour-id={tourId}
                        className={cn(
                          'h-8 py-1 w-full justify-start gap-3 transition-all duration-200 hover:bg-transparent hover:text-[inherit]',
          ...
          {!collapsed && (
            <button
              ...
              className={cn(
                'w-full flex items-center justify-between px-3 py-1 rounded-lg transition-colors hover:opacity-80',
                tierDisplay.color
              )}
            >
          ...
          {!collapsed && roleBadge && (
            <div className="flex items-center gap-2 px-3 py-1 rounded-lg" style={{ background: "rgba(0,229,255,0.06)", border: "1px solid rgba(0,229,255,0.15)" }}>
          ...
          <ReportIssueDialog
            trigger={
              <Button
                variant="ghost"
                className={cn(
                  'h-8 py-1 w-full justify-start gap-3',
                  collapsed && 'justify-center px-2'
                )}
