          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="border-border/50">
              <CardHeader>
                ...
                <CardDescription className="text-foreground">Recent activity across all tenants</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border/50">
              <CardHeader>
                ...
                <CardDescription className="text-foreground">Platform performance overview</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
