  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        feature: {
          companies: "hsl(var(--feature-companies))",
          employees: "hsl(var(--feature-employees))",
          customers: "hsl(var(--feature-customers))",
          leads: "hsl(var(--feature-leads))",
          appointments: "hsl(var(--feature-appointments))",
          quotes: "hsl(var(--feature-quotes))",
          invoices: "hsl(var(--feature-invoices))",
          inventory: "hsl(var(--feature-inventory))",
          warranties: "hsl(var(--feature-warranties))",
